...
// 路径配置变量
var cssSrc = './src/gcss/*.css',//css原始路径
    cssDist = './dist/gcss', // css合并后路径
    jsSrc = './src/gjs/*.js',
    jsDist = './dist/gjs', //js合并路径
    htmlSrc = './src/**/*.html',
    ...
    revPath = './rev/',
    condition = true,
    scssSrc ='./src/gcss/*.scss';

//转译scss
    gulp.task('scss',function(){
        gulp.src(scssSrc)  //这里是scss文件的目录
            .pipe(sass().on('error',sass.logError))
            .pipe(gulp.dest('./src/gcss'));  //这里是编译后css存放的目录
    })
