...
function ajax(){new Promise(function(e,t){$.ajax({url:"/path/to/file",type:"default GET (Other values: POST)",dataType:"default: Intelligent Guess (Other values: xml, json, script, or html)",data:{param1:"value1"},success:function(t){e(t)},error:function(e){}})})}
